...
export default async function Page() {
	...
	products.data.sort(
		(a: Stripe.Product, b: Stripe.Product) =>
			getIntervalValue(a) - getIntervalValue(b)
	);
						...
						<div className="flex flex-col">
							...
							{showDisableForm && (
								<div className="h-full flex flex-col justify-center items-center">
									...
									<Link
										className="inline-block mx-auto mt-2 text-sm text-primary hover:underline underline-offset-2"
							...
							{!session && (
								<p className="text-foreground-400 mt-4 italic text-center">
									Vous devez être connecté pour procéder au
									paiement
								</p>
							)}
						</div>
